...
st.slider("Pick a value", min_value=0, max_value=100,value=50,key="slider_eample")

st.divider()

st.header("Selection widgets")
color = st.selectbox("Favourite colour", ["Red", "Green", "Blue"])
options = st.multiselect("Choose some fruit", ["Apple","Banana", "Orange", "Grapes"])
